...
<html lang="tr">
<head>
    <title>2026/2027 Yaz Dönemi Kampanyası - Gençlik Dil</title>
    <meta charset="utf-8">
    ...
    <style>
        ...
        .welcome-banner {
            background: linear-gradient(135deg, var(--warning) 0%, #fb7185 100%);
            border-radius: 16px;
            padding: 28px 34px;
            color: white;
            margin-bottom: 30px;
        ...
        .welcome-text p { font-size: 14px; opacity: 0.92; margin: 0; }
        ...
        .border-orange .icon-wrapper { background: rgba(245, 158, 11, 0.12); color: var(--warning); }
    ...
    <div class="dashboard-container">
        <div class="welcome-banner">
            <div class="welcome-text">
                <h2>2026/2027 Yaz Dönemi Kampanyası</h2>
                <p>Şimdilik sadece başvurular modülü.</p>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <a href="yaz_basvurular.php" class="card-box border-orange">
                    <div class="icon-wrapper"><i class="fas fa-file-signature"></i></div>
                    <div class="card-title">Başvurular</div>
                    <div class="card-desc">Yaz dönemi kampanyası başvurularını listeleyin ve düzenleyin.</div>
                </a>
            </div>
        </div>
    </div>
